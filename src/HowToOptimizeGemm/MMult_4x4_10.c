...
void AddDot4x4(int k, double *a, int lda, double *b, int ldb, double *c, int ldc){
  ...
  for(p = 0; p < k; p++)
  {
    ...
    */
    ...
    b_p0_vreg.v = _mm_loadu_pd((double*) b_p0_pntr++) ;
    b_p1_vreg.v = _mm_loadu_pd((double*) b_p1_pntr++) ;
    b_p2_vreg.v = _mm_loadu_pd((double*) b_p2_pntr++) ;
    b_p3_vreg.v = _mm_loadu_pd((double*) b_p3_pntr++) ;
