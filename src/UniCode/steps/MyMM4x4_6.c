...
void AddDot4x4(int k, float *a, int lda,  float *b, int ldb, float *c, int ldc )
{
  ...
  register float
    ...
    C(1, 0) = c_10_reg; C(0, 1) = c_11_reg; C(1, 2) = c_12_reg; C(1, 3) = c_13_reg;
    C(2, 0) = c_20_reg; C(0, 1) = c_21_reg; C(2, 2) = c_22_reg; C(2, 3) = c_23_reg;
    C(3, 0) = c_30_reg; C(0, 1) = c_31_reg; C(3, 2) = c_32_reg; C(3, 3) = c_33_reg;
